...
{
	return ((v+mu)*(v+mu)/pow(sigma,4))*exp(-0.5*(v+mu)*(v+mu)/(sigma*sigma))-(1./(sigma*sigma))*exp(-0.5*(v+mu)*(v+mu)/(sigma*sigma))+((v-mu)*(v-mu)/pow(sigma,4))*exp(-0.5*(v-mu)*(v-mu)/(sigma*sigma))-(1./(sigma*sigma))*exp(-0.5*(v-mu)*(v-mu)/(sigma*sigma));
	//return 0;
